...
//        ImageIcon i1=new ImageIcon("C:\\Users\\chait\\eclipse-workspace\\project\\src\\icons\\add_employee.jpg");
...
//		add(image);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter("employee_details.txt", true))) {
                writer.write("Employee ID: " + empId);
                writer.newLine();
                writer.write("Name: " + name);
                writer.newLine();
                writer.write("Father's Name: " + fname);
                writer.newLine();
                ...
                writer.newLine();
                writer.write("Highest Education: " + education);
                writer.newLine();
                writer.write("Designation: " + designation);
                writer.newLine();
                writer.write("Aadhar Number: " + aadhar);
                writer.newLine();
                writer.newLine();
            } catch (IOException e) {
                e.printStackTrace();
